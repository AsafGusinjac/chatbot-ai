...
(function () {
    ...
    var CSS = [
        ...
        '.cart-action {',
        '  align-self: flex-start; width: calc(100% - 52px); max-width: calc(100% - 52px); margin: -2px 0 4px 52px;',
        '  display: flex; align-items: center; gap: 8px; animation: msgIn .25s cubic-bezier(.2,.7,.3,1) both;',
        '}',
        '.cart-action .buy-mini {',
        '  min-width: 0; min-height: 40px; display: inline-flex; align-items: center; justify-content: center; gap: 8px;',
        '  border: none; border-radius: 8px; background: linear-gradient(180deg, color-mix(in srgb, var(--accent) 92%, white), var(--accent));',
        '  color: #fff; box-shadow: 0 6px 14px rgba(0,0,0,.18); cursor: pointer; padding: 9px 13px;',
        '  font-family: inherit; font-size: 12.5px; font-weight: 750; white-space: nowrap;',
        '  transition: transform .1s ease, filter .15s ease;',
        '}',
        '.cart-action .buy-mini:hover:not(:disabled) { filter: brightness(1.1); }',
